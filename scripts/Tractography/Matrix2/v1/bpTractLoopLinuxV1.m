...
function bpTractLoopLinuxV1(StudyFolder, subID, ds, dt, threshold, side, tracts)
%% Preamble
...
bpPath=fullfile(DiffStudyFolder, num2str(subID),'MNINonLinear/Results/blueprint_threshold',...
...
if side=='RH'
    ...
    try
        ...
        savebpCiiLinuxV1(bpPath, subID, StrucStudyFolder, dim, ds, dt, tracts);
    catch
