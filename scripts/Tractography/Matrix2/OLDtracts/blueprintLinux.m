...
% dt = {'00'};
% threshold = 0;
%sub_list='/home//mydtifit/test100';
...
% matlab_call='matlab -r -nodesktop -nojvm -nosplash "cd('"'"'/data/Q1200/scripts/Matrix2'"'"'); blueprintLinux('"'"'/data/Q1200'"'"','"'"'/home//mydtifit/Diffusion/all_subjects.txt'"'"', 3, {'"'"'00'"'"'}, 0)"'
% $matlab_call
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
