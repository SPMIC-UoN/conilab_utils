...
function save_scene_medial_wall(ciftiPath, resultsFolder)
[~,ciftiName,~]=fileparts(ciftiPath);

%% Set search critera
bppath1='/Tools/wb_scene/average5_bpTracts'; % Replaced by ciftiPath
...
[~,newScene]=unix('cat /Tools/wb_scene/scene_file.scene');
