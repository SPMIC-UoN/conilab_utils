...
function bpTractLoopLinux_medial_wall(StudyFolder, subID, ds, dt, threshold, side, tracts)
%% Preamble
...
mat2Folder=([DiffStudyFolder '/' num2str(subID) '/MNINonLinear/Results/Tractography_medial_wall/'...
...
bpPath=fullfile(DiffStudyFolder, num2str(subID),'MNINonLinear/Results/blueprint_test',...
...
if side=='RH'
    ...
    try
        ...
        savebpCiiLinux_medial_wall(bpPath, subID, StrucStudyFolder, dim, ds, dt, tracts);
    catch
