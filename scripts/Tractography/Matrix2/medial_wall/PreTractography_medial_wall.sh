...
ResultsFolder="${DiffStudyFolder}/${Subject}/MNINonLinear/Results/Tractography_medial_wall"
...
${FSLDIR}/bin/surf2surf -i ${DownSampleFolder}/${Subject}.L.white${tempMSMsurf}.${LowResMesh}k_fs_LR.surf.gii -o ${ResultsFolder}/white.L.asc --outputtype=ASCII --values=1
${FSLDIR}/bin/surf2surf -i ${DownSampleFolder}/${Subject}.R.white${tempMSMsurf}.${LowResMesh}k_fs_LR.surf.gii -o ${ResultsFolder}/white.R.asc --outputtype=ASCII --values=1
